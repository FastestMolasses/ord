...
# Building Ord Python Package

In the `inscriptio-server` repo, run:
```bash
poetry env info --path
```

Copy this path and add `/bin/python` to the end of it. Example:
```bash
/Users/user/Documents/Inscriptio/inscriptio-server/.venv/bin/python
```

Now in this repo, run the following command:
```bash
poetry env use <your path>
```
